...
VoxelMesh.prototype.faceVertexUv = function(vs) {
  ...
  // var spans = {
  //   x0: vertices[0]     - vertices[1*3],
  //   x1: vertices[1*3]   - vertices[2*3],
  //   y0: vertices[0+1]   - vertices[1*3+1],
  //   y1: vertices[1*3+1] - vertices[2*3+1],
  //   z0: vertices[0+2]   - vertices[1*3+2],
  //   z1: vertices[1*3+2] - vertices[2*3+2]
  // }
